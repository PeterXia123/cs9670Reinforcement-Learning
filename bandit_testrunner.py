...
class BanditTestRunner():
        ...
        for run in tqdm( range(0, runs) ):
            ...
            for timestep in range(0,timesteps):
                for agent_id, agent in enumerate(self.agents):
                    ...
                    #import notice!!!!!!!!!!
                    self.bandit_env.random_walk_action_values()#this line will miss in the question1
    ...
    def visualize_results(self, save_filename, title, rewards_histories,
        ...
        for agent in self.agents:
            # import notice!!!!!!!!!!
            #labels.append(agent.policy.__str__()) #this line will apppear in the question1
            labels.append("non stationary(large) Sample average(greedy 1%)")#this line will disapear in the question1
            labels.append("non stationary(large) constant step (greedy 1%)")#this line will disapear in the question1
