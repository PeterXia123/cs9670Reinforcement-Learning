    ...
    def random_walk_action_values(self, mu=0, sigma=0.01):
        ...
        Args:
            mu: The mean of the normal distribution from which the random
                walk value is drawn.
            sigma: The standard deviation of the above distribution.
            we should change the sigma from 0.01 to 0.1 when come to second part of quesion.
        """

        ### YOUR CODE GOES HERE
        randomincrement = np.random.normal(mu,sigma,self.k)
        self.true_action_values += randomincrement
